...
class EditBugReportAndSuggestion extends StatefulWidget {
  const EditBugReportAndSuggestion({Key? key}) : super(key: key);

  @override
  State<EditBugReportAndSuggestion> createState() =>
      _EditBugReportAndSuggestionState();
}

class _EditBugReportAndSuggestionState
    extends State<EditBugReportAndSuggestion> {
  @override
  void initState() {
    getData();
    super.initState();
  ...
  getData() async {
    ...
    await objbugReportProvider.getbugAndReports(context);

    _title.text = objbugReportProvider.objBugsAndReportModel.title!;
    _description.text = objbugReportProvider.objBugsAndReportModel.description!;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          objbugReportProvider.isLoading ||
              ...
              Container(
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (isValid) {
                      await objbugReportProvider.updateBugAndReport(
                        context,
                        objbugReportProvider.objBugsAndReportModel.id!,
                        _description.text,
                        _title.text,
                      );
                    }
