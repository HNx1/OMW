...
class EditCookiesPolicy extends StatefulWidget {
  const EditCookiesPolicy({Key? key}) : super(key: key);

  @override
  State<EditCookiesPolicy> createState() => _EditCookiesPolicyState();
}

class _EditCookiesPolicyState extends State<EditCookiesPolicy> {
  @override
  void initState() {
    getData();
    super.initState();
  ...
  getData() async {
    ...
    await objCookieProvider.getCookies(context);

    _title.text = objCookieProvider.objCookieModel.title!;
    _description.text = objCookieProvider.objCookieModel.description!;
  }
              ...
              Container(
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (isValid) {
                      await objCookieProvider.updateCookie(
                        context,
                        objCookieProvider.objCookieModel.id!,
                        _description.text,
                        _title.text,
                      );
                    }
